...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "theme-color", content: "#9B6BFF" },
    ],
    links: [
      {
        rel: "stylesheet",
      ...
      { rel: "icon", href: "/favicon-96x96.png?v=2", sizes: "96x96", type: "image/png" },
      { rel: "icon", href: "/favicon-48x48.png?v=2", sizes: "48x48", type: "image/png" },
      { rel: "icon", href: "/favicon-32.png?v=2", sizes: "32x32", type: "image/png" },
      { rel: "icon", href: "/favicon-16.png?v=2", sizes: "16x16", type: "image/png" },
