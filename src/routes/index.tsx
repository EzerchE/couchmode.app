...
const DESC =
  "CouchMode is a Windows couch gaming utility for controller-ready living room PCs and supported handheld Xbox Mode setups. Free mode and a 7-day Pro trial are included in one app.";
const SHORT_DESC =
