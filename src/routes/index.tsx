...
const DESC =
  "CouchMode is a Windows couch gaming utility for controller-ready living room PCs and supported handheld Xbox Mode setups. Public beta includes Free mode and a 7-day Pro trial in one app.";
const SHORT_DESC =
