  ...
  entries: [
    {
      ...
      notes: [
        ...
        "CouchMode unterstützt Playnite an benutzerdefinierten Installationsorten und als portable Version jetzt zuverlässiger.",
  ...
  entries: [
    ...
    },
    {
      ...
      notes: [
        ...
        "Zaten bir üyeliğiniz varsa CouchMode, yeniden bağlanmanızı istemek yerine üyelik durumunuzu güncellemeyi önerir.",
    ...
    },
    {
      ...
      notes: [
        ...
        "Başlatıcı, oyun koluyla kullanılabilmesi için kendi pencerelerinden biri ön plana geldiğinde hazır kabul edilir.",
