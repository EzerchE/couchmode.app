...
export const sitemapLastmod: Partial<Record<LocaleId, Record<IndexableSurfaceId, SitemapLastmod>>> =
  {
    en: {
      ...
      "guide-resource-control-session-restore": "2026-09-18",
      "guide-windows-console": "2026-09-11",
      "guide-windows-handheld": "2026-08-21",
      "guide-xbox-mode-windows-11": "2026-09-18",
    },
    // These complete localized page sets first became indexable on this date.
    de: {
      ...everyIndexableSurface(germanTurkishPublicBaseline),
      guides: "2026-09-22",
      "guide-windows-console": "2026-09-22",
      "guide-xbox-mode-windows-11": "2026-09-22",
      "guide-windows-handheld": "2026-09-22",
      home: "2026-09-22",
      download: "2026-09-22",
      changelog: "2026-09-22",
      privacy: "2026-09-22",
      terms: "2026-09-22",
      "guide-playnite-launch": "2026-09-11",
      "guide-steam-big-picture": "2026-09-22",
      "guide-controller-session-settings": "2026-08-24",
      "guide-resource-control-session-restore": "2026-09-22",
    },
    fr: everyIndexableSurface(frenchSpanishPublicBaseline),
    es: {
      ...everyIndexableSurface(frenchSpanishPublicBaseline),
      download: "2026-09-22",
      changelog: "2026-09-22",
    },
    it: {
      ...everyIndexableSurface(italianPortuguesePolishPublicBaseline),
      download: "2026-09-22",
      changelog: "2026-09-22",
      "guide-controller-session-settings": "2026-09-22",
    },
    "pt-BR": {
      ...everyIndexableSurface(italianPortuguesePolishPublicBaseline),
      home: "2026-09-22",
    ...
    ja: everyIndexableSurface(japaneseKoreanPublicBaseline),
    ko: {
      ...everyIndexableSurface(japaneseKoreanPublicBaseline),
      home: "2026-09-22",
      download: "2026-09-22",
      support: "2026-09-22",
      guides: "2026-09-22",
    ...
    tr: {
      ...
      "guide-xbox-mode-windows-11": "2026-09-22",
      "guide-windows-handheld": "2026-09-22",
      "guide-playnite-focus": "2026-09-22",
      home: "2026-09-22",
      download: "2026-09-22",
      changelog: "2026-09-22",
      privacy: "2026-09-22",
